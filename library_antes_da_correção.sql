...
-- -----------------------------------------------------
-- Schema epiz_29388338_library
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema epiz_29388338_library
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `epiz_29388338_library` DEFAULT CHARACTER SET utf8 ;
USE `epiz_29388338_library` ;
...
CREATE TABLE IF NOT EXISTS `epiz_29388338_library`.`USUARIO` (
  ...
  CONSTRAINT `fk_ALUNO_TIPO_USUARIO`
    ...
    REFERENCES `epiz_29388338_library`.`TIPO_USUARIO` (`IDTIPO_USUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
